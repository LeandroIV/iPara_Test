...
class _NotificationSettingsScreenState extends State<NotificationSettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    try {
      ...
      setState(() {
        _enableMaintenanceReminders = prefs.getBool('enable_maintenance_reminders') ?? true;
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      ...
      await prefs.setBool('enable_maintenance_reminders', _enableMaintenanceReminders);
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    onChanged: _enableMaintenanceReminders
                        ? (value) {
                            setState(() {
                  ...
                  ListTile(
                    ...
                    enabled: _enableMaintenanceReminders && _enableDailyDigest,
                    onTap: _enableMaintenanceReminders && _enableDailyDigest
